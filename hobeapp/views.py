...
from hobeapp.models import Article, User, Create, Story,Comment,Profile

from .forms import UserRegistrationForm,CreateRegistrationForm, StoryRegistrationForm, ArticleRegistrationForm,ProfileRegistrationForm,CommentRegistrationForm
...
def create_comment(request):
    if request.method=="POST":
        ...
        form=CommentRegistrationForm()
    return render(request,"hobeproject/create_list.html",{"form":form})


def list_comment(request):
    comments=Comment.objects.all()
    return render(request,"hobeproject/create_list.html",{"comments":comments})
