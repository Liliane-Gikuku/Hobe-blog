...
from . import views
from .views import create_article, create_story, home_page, list_article, list_draft, list_story,register_user, list_user, view_story,activate,register_profile,list_profile
...
urlpatterns =[
    ...
    path("",list_article, name="article_view"),
